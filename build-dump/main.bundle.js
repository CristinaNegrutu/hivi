...
var ExcludedDomainsComponent = (function () {
    ...
    ExcludedDomainsComponent.prototype.deleteDomainFromList = function (domainName, index) {
        var domains = JSON.parse(localStorage.getItem("excluded_domains"));
        domains = domains.filter(function (item) { return item !== domainName; });
        this.excludedDomains = domains;
        localStorage.setItem("excluded_domains", null);
        localStorage.setItem("excluded_domains", JSON.stringify(domains));
    };
...
var SettingsComponent = (function () {
    function SettingsComponent(document) {
        this.document = document;
    }
...
module.exports = "<div class=\"row\">\n\t<div class=\"col s8  offset-s2\">\n\t\t<div class=\"card center-align\">\n\t\t\t<div class=\"card-content \">\n\t\t\t\t<h5>Choose theme</h5>\n\t\t\t\t<div class=\"row\">\n\t\t\t\t\t<div class=\"col s12\">\n\t\t\t\t\t\t<div class=\"row\">\n\t\t\t\t\t\t\t<div class=\"col s4 offset-s2\">\n\t\t\t\t\t\t\t\t<div style=\"cursor: pointer;\" (click)=\"changeTheme('LIGHT')\"\n\t\t\t\t\t\t\t\tclass=\"card\">\n\t\t\t\t\t\t\t\t\t<div class=\"card-image \" style=\"background-color: #e0e0e0\">\n\t\t\t\t\t\t\t\t\t\t<img [src]=\"'assets/light.png'\" class=\"responsive-img\" style=\"width:10em; margin:0 auto\">\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t<div class=\"card-content center\">\n\t\t\t\t\t\t\t\t\t\t<div class=\"card-action \">\n\t\t\t\t\t\t\t\t\t\t\t<a class=\"grey-text\" href=\"settings\">Light theme</a>\n\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div style=\"cursor: pointer;\" (click)=\"changeTheme('DARK')\"\n\t\t\t\t\t\t\tclass=\"col s4\">\n\t\t\t\t\t\t\t\t<div id=\"result\"></div>\n\t\t\t\t\t\t\t\t<div class=\"card\">\n\t\t\t\t\t\t\t\t\t<div class=\"card-image\" style=\"background-color: #424242\">\n\t\t\t\t\t\t\t\t\t\t<img [src]=\"'assets/dark.png'\" class=\"responsive-img\" style=\"width:10em; margin:0 auto\">\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t<div class=\"card-content center\">\n\t\t\t\t\t\t\t\t\t\t<div class=\"card-action \">\n\t\t\t\t\t\t\t\t\t\t\t<a class=\"grey-text\" href=\"settings\">Dark theme</a>\n\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>\n"
...
var ThemesComponent = (function () {
    ...
    ThemesComponent.prototype.changeTheme = function (value) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__date_filter_date_filter_component__ = __webpack_require__("../../../../../src/app/views/date-filter/date-filter.component.ts");
...
var BarChartComponent = (function () {
    function BarChartComponent(hiviService, filters) {
        this.hiviService = hiviService;
        this.filters = filters;
        this.shouldRefreshChartDefault = localStorage.getItem("shouldRefreshChart") === "1";
    }
    ...
    BarChartComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__hivi_service__["a" /* HiviService */],
            __WEBPACK_IMPORTED_MODULE_2__date_filter_date_filter_component__["a" /* DateFilterComponent */]])
    ], BarChartComponent);
...
var DateFilterComponent = (function () {
    function DateFilterComponent(hiviService) {
        this.hiviService = hiviService;
        /*
          The value can be one of the following strings:
          TODAY, LAST_WEEK, LAST_MONTH, ALL_TIME
          */
        this.selectedFilter = 'ALL_TIME';
...
var HiviService = (function () {
    ...
    HiviService.prototype.isUrlExcluded = function (url) {
        if (localStorage.getItem("excluded_domains") == null) {
            return false;
        }
        var excludedDomains = JSON.parse(localStorage.getItem("excluded_domains"));
        if (excludedDomains.indexOf(url) === -1) {
            return false;
        }
        return true;
    };
    HiviService.prototype.filterByInterval = function (interval) {
        switch (interval) {
            case "LAST_MONTH":
    ...
    HiviService.prototype.filterByDate = function (since, to) {
        ...
        this.dumpBookmarks();
        var aux = [];
        for (var i = 0; i < this.bookmarksList.length; i++) {
    ...
    HiviService.prototype.getTopMostBookmarked = function (n) {
        ...
        if (n === void 0) { n = 10; }
        var m = -1 * n;
        var orderedItems = this.bookmarksList.filter(function (url) { return _this.isUrlExcluded(url) == false; }).sort(this.compareItems);
    ...
    HiviService.prototype.getBarChartLabels = function () {
        var mostBookmarked = this.getTopMostBookmarked(10);
        var labels = [];
        var i;
        for (i = 0; i < mostBookmarked.length; i++) {
            labels.push(mostBookmarked[i].key);
...
var ListViewComponent = (function () {
    ...
    ListViewComponent.prototype.dumpBookmarks = function () {
        ...
        chrome.bookmarks.getTree(function (dummyArray) {
            //   function (dummyArray) {
            var domItem = 'bookmarks-list';
            _this.expandTree(dummyArray[0], domItem);
            //
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__hivi_service__ = __webpack_require__("../../../../../src/app/views/hivi.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PieChartComponent = (function () {
    ...
    PieChartComponent.prototype.redrawChart = function () {
        if (localStorage.getItem("shouldRefreshChart") === "1") {
            // console.log("BarChartComponent: redrawChart() method call...");
            this.chart.chart.destroy();
            this.chart.chart = 0;
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('myPieChart'),
    ...
    PieChartComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__hivi_service__["a" /* HiviService */]])
    ], PieChartComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__views_date_filter_date_filter_component__ = __webpack_require__("../../../../../src/app/views/date-filter/date-filter.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ViewsComponent = (function () {
    function ViewsComponent(domainsService, filters) {
        this.domainsService = domainsService;
        this.filters = filters;
    ...
    ViewsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__settings_excluded_domains_excluded_domains_service__["a" /* ExcludedDomainsService */],
            __WEBPACK_IMPORTED_MODULE_2__views_date_filter_date_filter_component__["a" /* DateFilterComponent */]])
    ], ViewsComponent);
