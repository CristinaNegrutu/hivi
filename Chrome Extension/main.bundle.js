...
var ListViewComponent = (function () {
    ...
    ListViewComponent.prototype.dumpBookmarks = function () {
        var dummyArray = chrome.bookmarks.getTree(function (dummyArray) {
            var i;
            jQuery('#bookmarks-list').append('<ul class="collapsible" data-collapsible="accordion">');
            for (i = 0; i < dummyArray[0].children.length; i++) {
                jQuery('#bookmarks-list ul').append('  <li class="bookmark-list-item">\n' +
                    '    <div class="collapsible-header grey lighten-2">\n' +
                ...
                for (j = 0; j < dummyArray[0].children[i].children.length; j++) {
                    if (typeof dummyArray[0].children[i].children[j].title !== 'undefined') {
                        jQuery('#bookmarks-list ul .bookmark-list-item').append('    <div class="collapsible-body"><p>' + dummyArray[0].children[i].children[j].title + '</p></div>\n');
                    }
                }
